...
d3.csv("https://gist.githubusercontent.com/emanueles/d8df8d875edda71aa2e2365fae2ce225/raw/1e949d3da02ed6caa21fe3a7a12a4e5a611a4bab/stocks.csv").then(function(data){
  ...
  var indexGoogle = null
  var indexFacebook = null
  ...
  data.forEach(function(d,i){
       ...
       if (indexFacebook == null && indexGoogle == null) {
         indexFacebook = +d.facebook;
         indexGoogle = +d.google;
         d.valueGoogle = 0;
         d.valueFacebook = 0;
       } else {
         d.valueGoogle = (((+d.google) - indexGoogle) / indexGoogle) * 100
         d.valueFacebook = (((d.facebook) - indexFacebook) / indexFacebook) * 100  
       }
       })
  return data
})
...
dateDim.group().reduceSum(d => d.valueGoogle)
)});
...
dateDim.group().reduceSum(d => d.valueFacebook)
)});
  ...
  main.variable(observer("acoes")).define("acoes", ["md","container","dc","d3","dateDim","percentGoogle","percentFacebook"], function(md,container,dc,d3,dateDim,percentGoogle,percentFacebook)
{
  ...
  main.variable(observer("datasetFilmes")).define("datasetFilmes", ["d3"], function(d3){return(
d3.json("https://raw.githubusercontent.com/emanueles/datavis-course/master/assets/files/observable/movies.json").then(function(data) {
  ...
  main.variable(observer("movies")).define("movies", ["crossfilter","datasetFilmes"], function(crossfilter,datasetFilmes){return(
crossfilter(datasetFilmes)
)});
...
movies.dimension(d => d.Genre)
  ...
  main.variable(observer("grossDim")).define("grossDim", ["movies"], function(movies){return(
movies.dimension(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("grossYearly")).define("grossYearly", ["yearDim"], function(yearDim){return(
yearDim.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("grossGenre")).define("grossGenre", ["genreDim"], function(genreDim){return(
genreDim.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("by_year")).define("by_year", ["md","container","dc","yearDim","d3","grossYearly"], function(md,container,dc,yearDim,d3,grossYearly)
{
  let view = md`${container('chart4', 'Total apurado anualmente')}`
  ...
  main.variable(observer("by_genre")).define("by_genre", ["md","container","dc","yearDim","d3","grossGenre"], function(md,container,dc,yearDim,d3,grossGenre)
{
