// https://observablehq.com/@romulofff/taxa-de-desemprego-nos-eua-em-agosto-de-2016-parte-2@156
...
d3.csv("https://gist.githubusercontent.com/emanueles/19cf3828bab232612c2b1599d831f690/raw/ddbaf62af22512a39360cc6741b40f5588b44aa0/county_names.csv").then(function(data){
  ...
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","nameById","rateById"], function(d3,nameById,rateById){return(
function showTooltip(county_id, x, y){
  ...
  console.log(nameById.get(county_id))
  console.log(rateById.get(county_id))
  d3.select("#tooltip")
  ...
  main.variable(observer("tooltip")).define("tooltip", ["d3"], function(d3)
{
  ...
  let node = d3.select("body")
    ...
    .attr("class", "hidden")
    .append("p")
    .html("<b>Name:</b> <span id='name'></span> <br><b>Taxa de desemprego:</b> <span id='taxa'></span>%")
  return node
}
);
